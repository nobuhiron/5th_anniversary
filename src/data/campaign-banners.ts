/**
 * nav セクションのバナー一覧。
 * campaign01〜04 の支給画像（nav-image--*.jpg）は見出し・ピル・シェブロンまで
 * 焼き込まれた完成版なので、文言は alt で読み上げる。
 * uchiwa だけは文字なしの写真＋HTML テキストで組むため alt は空にしており、
 * ここの alt は読み上げには使わない（文言の控えとして残す）。
...
export const CAMPAIGN_BANNERS = [
  {
    id: 'uchiwa',
    // うちわには対応するセクションがない（#campaign-uchiwa は存在しない）。
    // href なし = リンクにしない、というルールでテンプレート側が分岐する。
    href: null,
    alt: 'クーポン付きミニうちわプレゼント! ※なくなり次第終了 ※ケース配送品、冷凍品は対象外です',
  },
  {
    id: 'campaign01',
    href: '#campaign01',
